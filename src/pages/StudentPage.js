  ...
  return (
    <div className="student-dashboard flex justify-center items-center h-screen bg-gray-100">
      ...
      {isLoading ? (
        ...
        <div
          className={`flex w-full max-w-4xl space-x-6 p-6 transition-all duration-700 ease-out transform ${
            animate ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
          }`}
        >
          {/* Profile Card */}
          <div className="profile-container flex flex-col items-center bg-white shadow-xl p-6 rounded-lg w-1/3 h-auto transform transition-all duration-700 ease-out hover:scale-105">
            <FaUserAlt className="text-6xl text-gray-700 mb-4" />
            ...
            <button
              ...
              className="bg-red-500 text-white py-2 px-4 rounded-lg w-full hover:bg-red-600 mt-6 transition-all duration-300"
            >
              Log Out
            </button>
          </div>
